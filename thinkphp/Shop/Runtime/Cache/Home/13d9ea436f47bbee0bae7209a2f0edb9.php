                ...
                <div class="box">
                    <div class="box_1">
                        <div class="userCenterBox">
                            <div class="userMenu">
                                <a href="<?php echo U('user/ucenter');?>"><img src="<?php echo (IMG_PATH); ?>u1.gif" /> 欢迎页</a>
                                <a href=""><img src="<?php echo (IMG_PATH); ?>u2.gif" /> 用户信息</a>
                                <a href="<?php echo U('user/orderlist');?>"><img src="<?php echo (IMG_PATH); ?>u3.gif" /> 我的订单</a>
                                <a href="/thinkphp/index.php/Home/user/receadd.html" class="curs"><img src="<?php echo (IMG_PATH); ?>u4.gif" /> 收货地址</a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u5.gif" /> 我的收藏</a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u6.gif" /> 我的留言</a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u7.gif" /> 我的标签</a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u8.gif" /> 缺货登记</a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u9.gif" /> 我的红包</a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u10.gif" /> 我的推荐</a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u11.gif"> 我的评论</a>
                                <!--<a href="user.php?act=group_buy">我的团购</a>-->
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u12.gif" /> 跟踪包裹</a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>u13.gif" /> 资金管理</a>
                                <a href="#" style="background: none repeat scroll 0% 0% transparent; text-align: right; margin-right: 10px;"><img src="<?php echo (IMG_PATH); ?>bnt_sign.gif" /></a>
                            </div>      </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody><tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="consignee" class="inputBg" id="consignee_0" type="text" />
                                                (必填) </td>
                                            <td align="right" bgcolor="#ffffff">电子邮件地址：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="email" class="inputBg" id="email_0"  type="text" />
                                                (必填)</td>
                                        </tr>
                                        <tr>
                                            <td align="right" bgcolor="#ffffff">详细地址：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="address" class="inputBg" id="address_0" type="text" />
                                                (必填)</td>
                                            <td align="right" bgcolor="#ffffff">邮政编码：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="zipcode" class="inputBg" id="zipcode_0" type="text" /></td>
                                        </tr>
                                        <tr>
                                            <td align="right" bgcolor="#ffffff">电话：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="tel" class="inputBg" id="tel_0" type="text" />
                                                (必填)</td>
                                            <td align="right" bgcolor="#ffffff">手机：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="mobile" class="inputBg" id="mobile_0" type="text" /></td>
                                        </tr>
                                        <tr>
                                ...
                                <table bgcolor="#dddddd" border="0" cellpadding="5" cellspacing="1" width="100%">
                                    <tbody><tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" bgcolor="#ffffff">电子邮件地址：</td>
                                            <td align="left" bgcolor="#ffffff">
                                                <input name="email" class="inputBg" id="email_1" type="text" />
                                                (必填)</td>
                                        </tr>
                                        <tr>
                                            <td align="right" bgcolor="#ffffff">详细地址：</td>
