    ...
    <body>
            ...
            <div id="topNav" class="clearfix">
                <div style="float: left;"> 
                   <?php if(($loginstatus) == "1"): ?><font id="ECS_MEMBERZONE">
                        ...
                        <a href="#" onclick="confirm('您确定要退出吗?')">退出</a>
                            <?php else: ?>
        ...
        <div class="block">
            <div class="flowBox" style="margin: 0pt auto 70px;">
                <h6 style="text-align: center; height: 30px; line-height: 30px;">感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font style="color: red;"><?php echo ($orderifo['order_sn']); ?></font></h6>
                <table style="border: 1px solid rgb(221, 221, 221); margin: 20px auto;" align="center" bgcolor="#ffffff" border="0" cellpadding="15" cellspacing="0" width="99%">
                    <tbody><tr>
                            <td align="center" bgcolor="#ffffff">
                                您选定的配送方式为: <strong><?php echo ($orderifo['order_ship_name']); ?></strong>，您选定的支付方式为: <strong><?php echo ($orderifo['order_pay_name']); ?></strong>。您的应付款金额为: <strong>￥<?php echo ($orderifo['order_amount']); ?>元</strong>
                            </td>
                        </tr>
                        <tr>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo (IMG_PATH); ?>flow.htm" alt="YONGDA商城" border="0" /></a>
