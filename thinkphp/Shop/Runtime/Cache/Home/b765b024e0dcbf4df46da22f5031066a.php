...
<!--        <script type="text/javascript" src="/thinkphp/Public/Js/Base.js"></script>
        ...
        <script type="text/javascript" src="/thinkphp/Public/Js/ThinkAjax.js"></script>-->
        ...
        <style>
            #aa{
                background: url(<?php echo (IMG_PATH); ?>cart.jpg);
                width: 118px;
                height: 36px;
                border: 0;
                border-radius:4px;
                /*cursor:pointer; 表示当鼠标移动到该元素是 指针变成手的形状*/
                cursor:pointer;
                padding: 3px 0 0 0;
                /*margin-bottom: -50px;*/
            }
    ...
    <body style="cursor: auto;">
        <div class="block clearfix" style="position: relative; height: 98px;">
            <a href="<?php echo U('index/index');?>" name="top">
                <img class="logo" src="<?php echo (IMG_PATH); ?>logo.gif" />
            </a>
            ...
            <div id="mainNav" class="clearfix">
                ...
                <a href="<?php echo U('goods/index');?>" class="cur">GSM手机<span></span></a>
        ...
        <div class="block clearfix">
                ...
                <div style="display: block;" class="box" id="history_div">
                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="<?php echo (IMG_PATH); ?>8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue"></a></li><li><a href="#" target="_blank" title="飞利浦9@9v">飞利浦9@9v</a><br />本店售价：<font class="f1">￥399元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="<?php echo (IMG_PATH); ?>9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="B_blue"></a></li><li><a href="#" target="_blank" title="诺基亚E66">诺基亚E66</a><br />本店售价：<font class="f1">￥2298元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="<?php echo (IMG_PATH); ?>17_thumb_G_1241969394587.jpg" alt="夏新N7" class="B_blue"></a></li><li><a href="#" target="_blank" title="夏新N7">夏新N7</a><br />本店售价：<font class="f1">￥2300元</font><br /></li></ul><ul id="clear_history"><a onclick="clear_history()">[清空]</a></ul>  </div>
                    </div>
                </div>
                <div class="blank5"></div>
            </div>
            ...
            <div class="AreaR">
                <div id="goodsInfo" class="clearfix">
                    <div class="imgInfo">
                        <a style="position: relative; display: block; outline: 0pt none; text-decoration: none; width: 310px; -moz-user-select: none;" href="<?php echo (IMG_PATH); ?>200905/goods_img/9_P_1241511871575.jpg" id="zoom1" class="MagicZoom MagicThumb" title="诺基亚E66">
                            <img id="sim806035" src="<?php echo (UPLOADS_IMG_PATH); echo ($detail["goods_big_img"]); ?>" alt="诺基亚E66" height="310px" width="310px;" />
                            <div class="MagicZoomBigImageCont" style="width: 200px; height: 269px; overflow: hidden; z-index: 100; visibility: visible; position: absolute; top: -10000px; left: 327px; display: block;" id="bc806035">
                                ...
                                <div style="overflow: hidden;">
                                    <img style="position: relative; border-width: 0px; padding: 0px; left: 0px; top: 0px; display: block; visibility: visible;" src="<?php echo (IMG_PATH); ?>9_P_1241511871575.jpg" />
                                </div>
                        ...
                        <div style="text-align: center; position: relative; width: 100%;">
                            <a href="#">
                                <img style="position: absolute; left: 0pt;" alt="prev" src="<?php echo (IMG_PATH); ?>up.gif" /></a>
                            <a href="javascript:;" onclick="window.open('gallery.php?id=9'); return false;">
                                <img alt="zoom" src="<?php echo (IMG_PATH); ?>zoom.gif" />
                            </a>
                            <a href="#">
                                <img style="position: absolute; right: 0pt;" alt="next" src="<?php echo (IMG_PATH); ?>down.gif" /></a>
                        </div>
                        <div class="blank5"></div>

                        <div class="picture" id="imglist">
                            <a style="outline: 0pt none;" href="<?php echo (IMG_PATH); ?>200905/goods_img/9_P_1241511871575.jpg" rel="zoom1" rev="images/200905/goods_img/9_P_1241511871575.jpg" title="">
                                <img src="<?php echo (UPLOADS_IMG_PATH); echo ($detail["goods_small_img"]); ?>" alt="诺基亚E66" class="onbg" /></a>
                        </div>
                    </div>

                    <div class="textInfo">
                        <form action="" method="post" name="sen_wh" id="frm">
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品库存：</strong>
                                        <?php echo ($detail["goods_number"]); ?> 台             
                                    </dd>
                                </li>  
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品品牌：</strong><a href=""><?php echo ($detail["brand_name"]); ?></a>
                                    </dd>
                                </li>  
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品重量：</strong><?php echo ($detail["goods_weight"]); ?>      
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                        <strong>上架时间：</strong><?php echo ($detail["goods_create_time"]); ?>    
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>市场价格：</strong><font class="market">￥6780元</font><br />

                                        <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE"><?php echo ($detail["goods_price"]); ?></font><br />
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>用户评价：</strong>
                                        <img src="<?php echo (IMG_PATH); ?>stars5.gif" alt="comment rank 5">
                                    </dd>
                                </li>
                                <li class="padd">
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>购买数量：</strong>
                                        <input name="c_num" id="number" value="1" size="4" onblur="changePrice()" style="border: 1px solid rgb(204, 204, 204);" type="text" />
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                ...
                                <li class="padd">
                                    <a href="/thinkphp/index.php/Home/user/auction/goodsid/<?php echo ($_GET['goodsid']); ?>"><img src="<?php echo (IMG_PATH); ?>goumai2.gif"></a>
                                    <input type="submit" class="submit" id="aa" value="" onclick="add()" />
                                    <a href="#"><img src="<?php echo (IMG_PATH); ?>shoucang2.gif"></a>
                                    <a href="#"><img src="<?php echo (IMG_PATH); ?>tuijian.gif"></a>
                                </li>
                            </ul>
                        </form>
                                <?php $goodsid = $_GET['goodsid']; ?>
                                ...
                                <script type="text/javascript">
                                  ...
                                  $('#aa').click(function(){
                                      $.post('/thinkphp/index.php/Home/user/addcart',{
                                       c_num:$('#number').val(),
                                       c_goods_id:goodsid
                                      },
                                      function(date){
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix ie6">
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="<?php echo (IMG_PATH); ?>24_thumb_G_1241971981429.jpg" alt="P806" class="goodsimg"></a><br />
                                <p><a href="#" title="P806">P806</a></p> 
                                <font class="shop_s">￥2000元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="<?php echo (IMG_PATH); ?>22_thumb_G_1241971076803.jpg" alt="多普达Touch HD" class="goodsimg" /></a><br />
                                <p><a href="#" title="多普达Touch HD">多普达Touc...</a></p> 
                                <font class="shop_s">￥5999元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="<?php echo (IMG_PATH); ?>13_thumb_G_1241968002527.jpg" alt="诺基亚5320 XpressMusic" class="goodsimg" /></a><br />
                ...
                <div id="ECS_BOUGHT"><div class="box">
                    ...
                    <div class="blank5"></div></div><div id="ECS_COMMENT"> <div class="box">
                        <div class="box_1">
                            <h3><span class="text">用户评论</span>(共<font class="f1"><?php echo ($num); ?></font>条评论)</h3>
                            <div class="boxCenterList clearfix" style="height: 1%;">
                                <ul class="comments">
                                    <?php if(empty($commentinfo)): ?><li>暂时还没有任何用户评论</li>
                                        <?php else: ?>
                                        <?php if(is_array($commentinfo)): foreach($commentinfo as $key=>$commentin): ?><li>来自:<?php if(is_array($userinfo)): foreach($userinfo as $key=>$users): if($users['user_id'] == $commentin['comment_member_id']): echo ($users['user_name']); endif; endforeach; endif; ?>的评论
                                                <span style="float:right;">评论时间:<?php echo ($commentin['comment_time']); ?></span>
                                                <?php switch($commentin['comment_star']): case "1": ?><span style="margin-right: 200px; float: right;">本次评星:</span><img style="margin-right: 300px;" src="<?php echo (IMG_PATH); ?>stars1.gif" /><?php break;?>
                                                    <?php case "2": ?><span style="margin-right: 200px; float: right;">本次评星:</span><img style="margin-right: 300px;" src="<?php echo (IMG_PATH); ?>stars2.gif" /><?php break;?>
                                                    <?php case "3": ?><span style="margin-right: 200px; float: right;">本次评星:</span><img style="margin-right: 300px;" src="<?php echo (IMG_PATH); ?>stars3.gif" /><?php break;?>
                                                    <?php case "4": ?><span style="margin-right: 200px; float: right;">本次评星:</span><img style="margin-right: 300px;" src="<?php echo (IMG_PATH); ?>stars4.gif" /><?php break;?>
                                                    <?php case "5": ?><span style="margin-right: 200px; float: right;">本次评星:</span><img style="margin-right: 300px;" src="<?php echo (IMG_PATH); ?>stars5.gif" /><?php break;?>
                                                    <?php default: endswitch;?>
                                            </li>
                                            <li><?php echo ($commentin['comment_content']); ?></li><?php endforeach; endif; endif; ?> 
                                </ul>
                                ...
                                <div class="commentsList">
                                    <form action="/thinkphp/index.php/Home/user/comment"  method="post" name="commentForm" id="commentForm">
                                        <table border="0" cellpadding="0" cellspacing="5" width="710">
                                            <tbody><tr>
                                                    <td align="right" width="64">用户名：</td>
                                                    <td width="631"><?php echo ($_SESSION['user_name']); ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input name="comment_star" value="1" id="comment_rank1" type="radio" /> 
                                                        <img src="<?php echo (IMG_PATH); ?>stars1.gif" />
                                                        <input name="comment_star" value="2" id="comment_rank2" type="radio" /> 
                                                        <img src="<?php echo (IMG_PATH); ?>stars2.gif" />
                                                        <input name="comment_star" value="3" id="comment_rank3" type="radio" /> 
                                                        <img src="<?php echo (IMG_PATH); ?>stars3.gif" />
                                                        <input name="comment_star" value="4" id="comment_rank4" type="radio" /> 
                                                        <img src="<?php echo (IMG_PATH); ?>stars4.gif" />
                                                        <input name="comment_star" value="5" checked="checked" id="comment_rank5" type="radio" /> 
                                                        <img src="<?php echo (IMG_PATH); ?>stars5.gif" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" valign="top">评论内容：</td>
                                                    <td>
                                                        <textarea name="comment_content" class="inputBorder" style="height: 50px; width: 620px;"></textarea>
                                                        <input name="comment_goods_id" value="<?php echo ($_GET['goodsid']); ?>" type="hidden" />
                                                        <input name="comment_member_id" value="<?php echo ($_SESSION['user_id']); ?>" type="hidden" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <div style="padding-left: 15px; text-align: left; float: left;">
                                                            ...
                                                            <img src="<?php echo (IMG_PATH); ?>captcha.png" alt="captcha" onclick="this.src = 'captcha.php?' + Math.random()" class="captcha" />
                                                        </div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo (IMG_PATH); ?>goods.htm" alt="YONGDA商城" border="0" /></a>
        ...
        <img class="MagicThumb-image" style="position: absolute; top: -9999px; display: none;" src="<?php echo (IMG_PATH); ?>9_P_1241511871575.jpg" />
        <img src="<?php echo (IMG_PATH); ?>controlbar.htm" style="position: absolute; top: -999px;" />
        <img style="position: absolute; left: -10000px; top: -10000px;" src="<?php echo (IMG_PATH); ?>9_P_1241511871575.jpg" />
        <img style="position: absolute; left: -10000px; top: -10000px;" src="<?php echo (IMG_PATH); ?>9_P_1241511871575.jpg" />
    </body>
</html>