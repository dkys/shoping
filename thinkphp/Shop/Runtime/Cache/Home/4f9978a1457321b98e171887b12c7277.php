...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index_body">
        ...
        <div class="block box">
            <div class="blank"></div>
            <div id="ur_here" style="border: 1px solid #ccc;">
                当前位置: <a href="#">首页</a> <code>&gt;</code> 用户中心 
            </div>
            <div id="ur_here" style="margin:0;">
            <TABLE cellSpacing=0 cellPadding=0 width=953 align=center border=0>
                <TBODY>
                    <TR>
                        <TD height="10" width="100%">
                            <MARQUEE scrollAmount=10 scrollDelay=2 direction=rtl><a style="text-decoration:none; color:#333333" href="#" target="_blank">欢迎光临手机网,我们的宗旨：诚信经营、服务客户！
                                    <MARQUEE onmouseover=this.stop() onmouseout=this.start() scrollAmount=2><U><FONT color=red>
            ...
            <div class="block clearfix">
                    ...
                    <div class="box">
                        ...
                        <div class="box_1">
                            <div class="top10List clearfix">
                                <ul class="clearfix">
                                    <img src="<?php echo (IMG_PATH); ?>top_1.gif" class="iteration">
                                        <li class="topimg">
                                            <a href="#"><img src="<?php echo (IMG_PATH); ?>3_thumb_G_1241422082679.jpg" alt="" class="samllimg"></a>
                                        </li>
                                ...
                                <ul class="clearfix">
                                    <img src="<?php echo (IMG_PATH); ?>top_2.gif" class="iteration">
                                        <li class="topimg">
                                            <a href="#"><img src="<?php echo (IMG_PATH); ?>24_thumb_G_1241971981429.jpg" alt="" class="samllimg"></a>
                                        </li>
                                ...
                                <ul class="clearfix">
                                    <img src="<?php echo (IMG_PATH); ?>top_3.gif" class="iteration">
                                        <li class="topimg">
                                            <a href="#"><img src="<?php echo (IMG_PATH); ?>12_thumb_G_1241965978410.jpg" alt="" class="samllimg"></a>
                                        </li>
                                ...
                                <ul class="clearfix">
                                    <img src="<?php echo (IMG_PATH); ?>top_4.gif" class="iteration">
                                ...
                                <ul class="clearfix">
                                    <img src="<?php echo (IMG_PATH); ?>top_5.gif" class="iteration">
                                ...
                                <ul class="clearfix">
                                    <img src="<?php echo (IMG_PATH); ?>top_6.gif" class="iteration">
                                ...
                                <ul class="clearfix">
                                    <img src="<?php echo (IMG_PATH); ?>top_7.gif" class="iteration">
                    ...
                    <div class="blank5"></div><div class="box">  <h3><span>品牌专区</span></h3>
                        <div class="box_1">
                            <div class=" brands clearfix">
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>1240803062307572427.gif" alt="诺基亚 (7)"></a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>1240802922410634065.gif" alt="摩托罗拉 (1)"></a>
                                <a href="#"><img src="<?php echo (IMG_PATH); ?>1240803144788047486.gif" alt="多普达 (1)"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="AreaM">
                    <div class="box clearfix">
                        <div id="focus">
                            <img src="<?php echo (IMG_PATH); ?>111.jpg" width="515" height="160" alt="" />
                        </div>       
                    </div>
                    ...
                    <div id="show_hot_area" class="clearfix">
                        <?php if(is_array($goodsinfo)): $i = 0; $__LIST__ = array_slice($goodsinfo,0,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="goodsItem">
                                <a href="/thinkphp/index.php/Home/goods/detail/goodsid/<?php echo ($vo["goods_id"]); ?>"><img src="<?php echo (UPLOADS_IMG_PATH); echo ($vo["goods_big_img"]); ?>" alt="诺基亚E66" class="goodsimg"></a><br />
                                <p class="f1"><a href="#" title="诺基亚E66"><?php echo ($vo["goods_name"]); ?></a></p>
                                <font class="market"><?php echo ($vo["goods_price"]); ?></font><br />
                                <font class="f1">
                                    <?php echo ($vo["goods_price"]); ?>                     </font>
                    ...
                    <div id="show_best_area" class="clearfix">
                        <?php if(is_array($goodsinfo)): $i = 0; $__LIST__ = array_slice($goodsinfo,3,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="goodsItem">
                    ...
                    <div id="show_new_area" class="clearfix">
                        <?php if(is_array($goodsinfo)): $i = 0; $__LIST__ = array_slice($goodsinfo,6,3,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="goodsItem">

                                <a href="/thinkphp/index.php/Home/goods/detail/goodsid/<?php echo ($vo["goods_id"]); ?>"><img src="<?php echo (UPLOADS_IMG_PATH); echo ($vo["goods_big_img"]); ?>" alt="诺基亚E66" class="goodsimg"></a><br />
                                <p class="f1"><a href="#" title="诺基亚E66"><?php echo ($vo["goods_name"]); ?></a></p>
                                <font class="market"><?php echo ($vo["goods_price"]); ?>元</font><br />
                                <font class="f1">
                                    <?php echo ($vo["goods_price"]); ?>                     </font>
                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo (IMG_PATH); ?>ecmoban_link.jpg" alt="YONGDA商城" border="0"></a>

                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="<?php echo (IMG_PATH); ?>yongda_logo.gif" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
