                        ...
                        <form id="yw0" action="/index.php/Home/User/register" method="post">                <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width:87%;">
                                            <input class="inputBg" size="25" name="user_name" id="User_username" type="text" />                  
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="pwd" id="User_password" type="password" />         
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><label for="User_password2">密码确认</label></td>
                                        <td>
                                            <input class="inputBg" size="25" name="repwd" id="User_password2" type="password" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="inputBg" size="25" name="user_email" id="User_user_email" type="text" />    
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="user_education" id="User_user_xueli">
