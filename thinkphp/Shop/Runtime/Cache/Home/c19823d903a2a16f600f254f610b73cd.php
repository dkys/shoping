                ...
                <div class="box">
                    <div class="box_1">
                        <div class="userCenterBox">
                            <div class="userMenu">
                                <a href="/thinkphp/index.php/Home/user/ucenter.html" class="curs"><img src="<?php echo (IMG_PATH); ?>u1.gif" /> 欢迎页</a>
                                <a href=""><img src="<?php echo (IMG_PATH); ?>u2.gif" /> 用户信息</a>
                                <a href="<?php echo U('user/orderlist');?>"><img src="<?php echo (IMG_PATH); ?>u3.gif" /> 我的订单</a>
                                <a href="<?php echo U('user/receadd');?>"><img src="<?php echo (IMG_PATH); ?>u4.gif" /> 收货地址</a>
                ...
                <div class="box">
                    <div class="box_1">
                        <div class="userCenterBox boxCenterList clearfix" style="">
                            ...
                            <font class="f5"><b class="f4"><?php echo ($_SESSION['user_name']); ?></b> 欢迎您回到 YONGDA！</font><br />
                            <div class="blank"></div>
                            ...
                            <div style="margin: 5px 0pt; border: 1px solid rgb(247, 221, 152); padding: 10px 20px; background-color: rgb(255, 250, 213);">
                                <img src="<?php echo (IMG_PATH); ?>note.gif" alt="note" />&nbsp;用户中心公告！           </div>
                            <br /><br />
