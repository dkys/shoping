...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="block">
            <form action="/index.php/Home/User/payment" method="post" name="theForm" id="theForm" >
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <?php if(is_array($cartinfo)): foreach($cartinfo as $key=>$vo): ?><tr>
                                <td>
                                ...
                                <td align="right"><?php echo ($vo["c_num"]); ?></td>
                                <td align="right">￥<?php echo ($vo['c_num'] * $vo['goods_price']); ?>元</td>
                            </tr><?php endforeach; endif; ?>
                            
                            <tr>
                                <td colspan="7">
                                    购物金额小计 ￥<?php echo ($price_sum); ?>元，比市场价 ￥6012.00元 节省了 ￥1002.00元 (17%)              </td>
                            </tr>
                        </tbody></table>
                </div>
                <div class="blank"></div>
                <div class="flowBox">
                    ...
                    <?php if(is_array($rece)): foreach($rece as $key=>$receinfo): ?><table cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                                <td>收货人姓名:</td>
                                <td><?php echo ($receinfo["receiving_name"]); ?></td>
                                <td>电子邮件地址:</td>
                                <td><?php echo ($receinfo["receiving_email"]); ?></td>
                            </tr>
                            <tr>
                                <td>详细地址:</td>
                                <td><?php echo ($receinfo["receiving_add"]); ?></td>
                                <td>邮政编码:</td>
                                <td><?php echo ($receinfo["receiving_postcode"]); ?></td>
                            </tr>
                            <tr>
                                <td>电话:</td>
                                <td><?php echo ($receinfo["receiving_tel"]); ?></td>
                                <td>手机:</td>
                                <td><?php echo ($receinfo["receiving_mobile"]); ?></td>
                            </tr>
                            <tr>
                                <td>标志建筑:</td>
                                <td> </td>
                ...
                <div class="flowBox">
                    ...
                    <table id="shippingTable" cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <tr>
                                <td valign="top"><input name="order_ship_name" checked="checked" value="申通快递"  type="radio" />
                                </td>
                            ...
                            <tr>
                                <td valign="top"><input name="order_ship_name" value="城际快递"  type="radio" />
                                </td>
                            ...
                            <tr>
                                <td valign="top"><input name="order_ship_name" value="邮局平邮"   type="radio" />
                                </td>
                ...
                <div class="flowBox">
                    ...
                    <table id="paymentTable" cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <tr>
                                <td valign="top"><input name="order_pay_name" checked="checked" value="余额支付" iscod="0" type="radio" /></td>
                            ...
                            <tr>
                                <td valign="top"><input name="order_pay_name" value="银行汇款/转帐" iscod="0" type="radio" /></td>
                            ...
                            <tr>
                                <td valign="top"><input name="order_pay_name" value="货到付款" iscod="1" disabled="true" type="radio" /></td>
                    ...
                    <div id="ECS_ORDERTOTAL">
                        <table cellpadding="5" cellspacing="1" width="99%">
                            <tbody><tr>
                                ...
                                <tr>
                                    <td align="right">
                                        商品总价: <font class="f4_b">￥<?php echo ($price_sum); ?>元</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right"> 应付款金额: <font class="f4_b">￥<?php echo ($price_sum); ?>元</font>
                                    </td>
                                </tr>
                            </tbody></table>
                    </div>           <div style="margin: 8px auto;">
                        <input name="order_consignee_id" value="<?php echo ($receinfo["receiving_id"]); ?>" type="hidden" />
                        <input name="order_amount" value="<?php echo ($price_sum); ?>" type="hidden" />
                        <input name="order_goods_id" value="<?php echo ($vo["goods_id"]); ?>" type="hidden" />
                    </div>
                </div>
                <!--input type="image" 与 type="submit" 两者都可以做为表单提交  
                    区别:input type="image" 会把鼠标点击时的坐标也一并传递出去
                
                    -->
                        <input src="<?php echo (IMG_PATH); ?>bnt_subOrder.gif" onclick="payment()" type="image" />
            </form>
        </div>
        <script src="https://cdn.static.runoob.com/libs/jquery/1.10.2/jquery.min.js"></script>
        <script type="text/javascript">
//            function payment(){
//                window.location='/index.php/Home/User/payment';
//            }
        </script>
        <div class="blank"></div>
        <div class="block">
